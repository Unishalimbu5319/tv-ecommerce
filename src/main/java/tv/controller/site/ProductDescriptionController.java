...
/**
 * Servlet implementation class ProductDescriptionController
 */
@WebServlet("/product")
public class ProductDescriptionController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/views/site/productDescription.jsp");
